...
def train_model(params):
    ...
    if(params['RELOAD'] == 0): # build new model 
        video_model = VideoDesc_Model(params, type=params['MODEL_TYPE'], verbose=params['VERBOSE'],
...
def apply_Video_model(params):
    ...
    ########### Load model
    image_model = loadModel(params['STORE_PATH'], params['RELOAD'])
    image_model.setOptimizer()
    ###########
    ...
    for s in params["EVAL_ON_SETS"]:
        ...
        if params['BEAM_SEARCH']:
            ...
            predictions = image_model.decode_predictions(predictions, 1, # always set temperature to 1
                                                                vocab, params['SAMPLING'], verbose=params['VERBOSE'])


        # Store result
        filepath = image_model.model_path+'/'+ s +'_sampling.pred' # results file
        ...
        for metric in params['METRICS']:
            ...
            filepath = image_model.model_path + '/' + s + '_sampling.' + metric  # results file
